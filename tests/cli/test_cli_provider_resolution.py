...
def test_cli_cognition_deep_mode_blocks_cheap_route_via_publish_trigger(monkeypatch):
    ...
    # "publish" is in cognition's risky_external_actions trigger set but is
    # NOT in smart_model_routing._COMPLEX_KEYWORDS, so without the gate the
    # message would be cheap-routed.
